...
The collector needs read-only AWS permissions in each target account, tiered
by collection level. The full policy and per-level action lists are on the
[configuration page](docs/configuration.md#required-iam-permissions).
